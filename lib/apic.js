...
define(function (require) {
    ...
    var placeholder = /^{(.+)}$/,
        ...
        languageHeaders = { safe: 'Accept-Language', unsafe: 'Content-Language' };
    ...
    return function apic(desc, options) {
        ...
        options.languageHeaders = options.languageHeaders || languageHeaders;
        ...
        function method(verb, uri, res, params, secure) {
            ...
            return function () {
                ...
                if (language) {
                    headers[options.languageHeaders[safe ? 'safe' : 'unsafe']] = language;
                }
